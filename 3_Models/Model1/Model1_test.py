''' Model 1 trains a 1-branch CNN using the original tiles'''
...
#Creating Model
#1-branch CNN model with 3-channel input.
...
final_df.to_csv('results/model1/model1_df{}.csv'.format(j),index=False)
