''' Model 2 trains a 1-branch CNN using the context tiles.'''
...
tiles_path1='./context_tiles/'
tiles_path2='./context_tiles/{}'
...
##---First Run
#Freezing all layers but last
for layer in cnn_model.layers[0:-1]:
...
final_df.to_csv('results/model2/model2_df{}.csv'.format(j),index=False)
